...
function Bottom(props) {
  ...
  const noChecked = useMemo(() => {
      return (
        Object.keys(checkedTicketsTypes).length === 0 &&
  ...
  return (
    <div className="bottom">
      <div className="bottom-filters">
        ...
        <span className="item" onClick={toggleHighSpeed}>
          <i
            className={classnames("icon iconfont icon-slef", {
              "item-on": highSpeed,
            })}
          >
            &#xe65a;
        ...
        <span className="item" onClick={toggleOnlyTickets}>
          <i
            className={classnames("icon iconfont icon-slef", {
              "item-on": onlyTickets,
            })}
        ...
        <span className="item" onClick={toggleIsFiltersVisible}>
          <i
            className={classnames("icon iconfont icon-slef", {
